...
@Mod(clientSideOnly = true, modid = Main.MODID, name = Main.NAME, version = Main.VERSION , acceptedMinecraftVersions = Main.ACCEPTVER)
public class Main {
	
	public static final String MODID = "drp";
	public static final String VERSION = "1.12.2";
	public static final String NAME = "Discord Rich Presence";
	public static final String ACCEPTVER = "[1.12.2]";
